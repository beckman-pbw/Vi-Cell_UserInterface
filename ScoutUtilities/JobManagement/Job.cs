...
namespace ScoutUtilities.JobManagement
{
    /// <summary>
    /// Taken from a blog post - http://www.tomdupont.net/2015/06/how-to-kill-child-process-when-parent.html
    /// </summary>
    public class Job : Disposable
    {
