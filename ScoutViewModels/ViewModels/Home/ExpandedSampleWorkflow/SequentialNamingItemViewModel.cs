...
{
    public class SequentialNamingItemViewModel : BaseViewModel, ICloneable
    {
        #region Constructor
        ...
        public ushort CurrentSeqNumber
        {
        ...
        public object Clone()
        {
            return new SequentialNamingItemViewModel(_sequentialNamingItem);
        }
