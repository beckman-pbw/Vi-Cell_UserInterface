...
{
    [TestFixture()]
    public class ScheduledExportAddEditViewModelTests
    {
        ...
        public void Setup()
        {
            ...
            ctManagerMock.Setup(m => m.GetCellTypeDomain(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>())).Returns(new CellTypeDomain());
            ctManagerMock.Setup(m => m.GetQualityControlDomain(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>())).Returns(new QualityControlDomain());
        ...
        public void FieldsAreValidTest_Success()
        {
            ...
            var exportDomain = new SampleResultsScheduledExportDomain();
            var args = new ScheduledExportDialogEventArgs<SampleResultsScheduledExportDomain>(exportDomain, false);
            var vm = _kernel.Get<IScoutViewModelFactory>()
                            .CreateScheduledExportAddEditViewModel(args, null);
            Assert.IsNotNull(vm);
        ...
        [Test()]
        public void FieldsAreValidTest_Failure_BadDataFilterCriteria_CellTypeSelection()
        {
            UseDefaultFileSystemService();
            var exportDomain = new SampleResultsScheduledExportDomain();
            var args = new ScheduledExportDialogEventArgs<SampleResultsScheduledExportDomain>(exportDomain, false);
            ...
            vm.ScheduledExport = GetScheduledExportDomain();
            vm.ScheduledExport.DataFilterCriteria.SelectedCellTypeOrQualityControlGroup = null;
            vm.ScheduledExport.DataFilterCriteria.IsAllCellTypeSelected = false;
            Assert.IsFalse(vm.FieldsAreValid());
        }

        [Test()]
        public void FieldsAreValidTest_Failure_BadDataFilterCriteria_Username()
        {
            UseDefaultFileSystemService();
            var exportDomain = new SampleResultsScheduledExportDomain();
            var args = new ScheduledExportDialogEventArgs<SampleResultsScheduledExportDomain>(exportDomain, false);
            ...
            vm.ScheduledExport = GetScheduledExportDomain();
            vm.ScheduledExport.DataFilterCriteria.SelectedUsername = string.Empty;
            Assert.IsFalse(vm.FieldsAreValid());
        }
        ...
        public void ScheduledExport_DirectoryUpdatesWithFolderSelectDialog()
        {
            ...
            var newPath = @"C:\Instrument\Export\TestFolder";
            _dialogCallerMock
        ...
        public void ScheduledExport_DirectoryDoesNotUpdateWhenFolderSelectDialogCancelled()
        {
            ...
            UseDefaultFileSystemService();
            var initialPath = @"C:\Instrument\Export";
            var newPath = @"C:\MyCoolFolder\ThatLives\Here";
            _dialogCallerMock
                .Setup(m => m.OpenFolderSelectDialog(It.IsAny<object>(), It.IsAny<FolderSelectDialogEventArgs>()))
                .Callback<object, FolderSelectDialogEventArgs>((o, f) => f.SelectedFolderPath = newPath)
                .Returns(false);
